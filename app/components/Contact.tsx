    ...
    <section id="Contact" className="text-center py-16 px-5 sm:px-10 lg:px-20">
      ...
      >
        <input
          type="text"
          placeholder="Name"
          className="w-full bg-blue-800/15 text-black placeholder-black py-3 px-4 rounded-[10px] mb-4 focus:outline-none focus:ring-2 focus:ring-blue-800"
        ...
        <textarea
          placeholder="Message"
          className="w-full bg-blue-800/15 text-black placeholder-black py-3 px-4 rounded-[10px] mb-4 focus:outline-none focus:ring-2 focus:ring-[#027223]"
          {...register("message", {
        ...
        <button
          type="submit"
          className="w-full font-Jakarta bg-blue-800 text-white rounded-lg font-semibold py-3 px-4 focus:scale-105 hover:scale-105 transition cursor-pointer"
          disabled={loading}
        >
          {loading ? (
