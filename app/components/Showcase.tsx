...
import img2 from '@/public/images/prezzie1.jpg'; 
import img1 from '@/public/images/elite10.jpg';
import img3 from '@/public/images/elite14.jpg'; 
import img4 from '@/public/images/prezzie3.jpg';
    ...
    <section id='Showcase' className="py-16 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <motion.h1
          ...
          className="text-3xl text-blue-800 text-center sm:text-4xl lg:text-5xl xl:text-6xl font-bold leading-tight"
