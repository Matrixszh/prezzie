...
import ckit from '@/public/images/prezzie3.jpeg';
...
const services = [
  ...
  { name: 'Dental Kits', description: 'Designed for one-time use, providing essential oral care for hospital patients', image: dkit },
];
    ...
    <section id="#" className="py-16 px-5 sm:px-10 lg:px-20 text-center">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <span className="absolute inset-0 bg-blue-800 transition-transform duration-500 ease-out transform -translate-x-full group-hover:translate-x-0" />
        </a>
                    ...
                    >
                      <span
                        className={`text-lg font-Jost sm:text-xl lg:text-2xl font-semibold relative ${
                          activeService === service.name ? 'text-blue-800' : 'text-black '
                        }`}
                      >
                        {service.name}
                        <span
